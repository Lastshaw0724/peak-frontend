...
import { usarInventario } from '@/hooks/usar-inventario';
...
export function ReporteStockInventario() {
    const { inventory } = usarInventario();
    const { lowStockThreshold } = usarPreferencias();
